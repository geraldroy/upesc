                ...
                <div class="container bottom-border padding-vert-30">
                    <div class="row">
                        ...
                        <div class="col-md-4 margin-bottom-20">
                            ...
                            <p>
                                <span class="fa-phone">Telephone:</span>(02) 434-3650
                                <br>
                                <span class="fa-envelope">Email:</span>
                                <a href="mailto:contact@upesc.org">contact@upesc.org</a>
                                <br>
                                <span class="fa-link">Website:</span>
                                <a href="http://www.upesc.org">www.upesc.org</a>
                            </p>
                            <p>Rm 123, Melchor Hall,
                                <br>UP Diliman, Quezon City</p>
                        </div>
                        <!-- End Contact Details -->
                        <!-- Sample Menu -->
                        <div class="col-md-4 margin-bottom-20">
